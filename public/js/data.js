...
export const TECH_CARDS = {
  power: [
    { tier: 1, cost: 6,  tech: 0, def: 1, trade: 4, name: '共享電動滑板車', icon: '🛴',
      desc: '隨騎隨丟,燒投資人的錢補貼你的車資',
      lore: '2017 年起 Bird、Lime 把電動滑板車灑滿歐美街頭,用創投補貼狂搶市占;隨借隨還的便利背後,是人行道亂象與燒錢黑洞。' },
    { tier: 2, cost: 11, tech: 8, def: 1, trade: 5, name: '全自動駕駛 FSD', icon: '🚗',
      desc: '完全自動駕駛(監督版)(隨時準備接管)(明年一定完成)',
      lore: '特斯拉 FSD 十年來年年喊「明年就到」,實際仍是需雙手待命的輔助駕駛;它把自駕願景做成了最成功也最具爭議的科技期貨。' },
    { tier: 3, cost: 18, tech: 15, def: 3, trade: 6, name: '低軌衛星星鏈', icon: '🛰️',
      desc: '幾千顆衛星掛天上,戰時秒變通訊生命線', prodRatio: { money: 1, power: 2, oil: 1 },
      lore: 'SpaceX Starlink 在低軌道部署上萬顆衛星,讓偏鄉與戰地都能上網;在烏俄戰場上,它一度成為左右戰局的通訊命脈。' },
    { tier: 4, cost: 28, tech: 45, def: 4, trade: 7, name: '筷子夾火箭', icon: '🦾',
      desc: '發射塔機械臂空中接住回收火箭,全網直播看傻',
      lore: '2024 年 SpaceX 星艦首度以發射塔「機械筷子」在空中夾住回收助推器,全球直播看傻——可重複使用火箭把航太成本壓到地板。' },
    { tier: 5, cost: 44, tech: 90, def: 5, trade: 9, name: '火星殖民艦隊', icon: '🪐',
      desc: 'Plan B:地球玩壞了就搬家', prodRatio: { money: 2, power: 1, oil: 1 },
      special: { type: 'income', val: 3, text: '星際船票:每回合 +3 金錢' },
      lore: '馬斯克的終極願景:把人類變成跨行星物種,地球若玩壞了還有 Plan B;目前仍停在 PPT 與星艦試飛的階段。' },
  ],
  hardware: [
    { tier: 1, cost: 6,  tech: 5, def: 1, trade: 1, name: '血汗組裝廠', icon: '🏭',
      desc: '百萬人三班倒,毛利保三趴', prodRatio: { money: 1, power: 1, oil: 2 },
      lore: '富士康式的代工帝國,百萬作業員三班輪轉,用極致規模與微薄毛利撐起全球消費電子供應鏈。' },
    { tier: 2, cost: 11, tech: 12, def: 1, trade: 2, name: '摺疊螢幕手機', icon: '📲',
      desc: '摺一萬次就壞,但發表會真的帥',
      lore: '三星、華為帶起摺疊機風潮,發表會上很帥、鉸鍊壽命卻是隱憂;它是手機走到創新瓶頸後的差異化突圍。' },
    { tier: 3, cost: 18, tech: 25, def: 2, trade: 2, name: 'CoWoS 先進封裝', icon: '📦',
      desc: '全球 AI 晶片大塞車的瓶頸,排單排到後年',
      lore: '台積電的 2.5D 封裝技術,把 GPU 與高頻寬記憶體疊在一起;AI 浪潮下它成了全球算力擴張的最大瓶頸,訂單排到後年。' },
    { tier: 4, cost: 28, tech: 60, def: 3, trade: 3, name: '2奈米製程', icon: '⚛️',
      desc: '良率數字是比飛彈座標還機密的國家機密',
      lore: '晶圓製程逼近物理極限,2nm 改用 GAA 環繞閘極;良率與產能被視為比飛彈座標還機密的國安級籌碼。' },
    { tier: 5, cost: 44, tech: 120, def: 4, trade: 4, name: '量子晶片', icon: '🧊',
      desc: '室溫下還跑不太動,但股價已經先漲完了', prodRatio: { money: 1, power: 2, oil: 1 },
      lore: 'Google、IBM 競逐量子霸權,量子位元需逼近絕對零度運作;距離實用還很遠,但概念股早已先漲一波。' },
  ],
  info: [
    { tier: 1, cost: 6,  tech: 0, def: 3, trade: 1, name: '機房資料中心', icon: '🖥️',
      desc: '嗡嗡作響的鐵皮屋,裡面住著整個網際網路',
      lore: '嗡嗡作響的鐵皮機房,是整個網際網路的物理身體;雲端再虛無,資料終究睡在某座吃電怪獸般的資料中心裡。' },
    { tier: 2, cost: 11, tech: 8, def: 5, trade: 2, name: 'CDN 加速網路', icon: '🌐',
      desc: '擋 DDoS 之餘順便快取全世界的貓圖', prodRatio: { money: 2, power: 1, oil: 1 },
      lore: 'Cloudflare、Akamai 把內容快取到離你最近的節點,順手扛下 DDoS 攻擊;現代網路看不見的高速公路。' },
    { tier: 3, cost: 18, tech: 15, def: 8, trade: 2, name: '主權雲', icon: '☁️',
      desc: '資料不出國,別國法院傳票進不來',
      special: { type: 'aura', val: 2, text: '資安光環:同區你的其他卡片防護 +2' },
      lore: '各國要求資料「不出國」、不受外國法律管轄,催生了主權雲;這是數位時代的資料民族主義。' },
    { tier: 4, cost: 28, tech: 40, def: 10, trade: 4, name: '零信任防禦網', icon: '🔐',
      desc: '連 CEO 登入都要刷三次臉',
      special: { type: 'aura', val: 3, text: '資安光環:同區你的其他卡片防護 +3' },
      lore: 'Zero Trust:預設誰都不可信,連 CEO 登入都要層層驗證;遠距辦公與供應鏈攻擊後的資安新標準。' },
    { tier: 5, cost: 44, tech: 80, def: 12, trade: 6, name: '全球海底纜線網', icon: '🌊',
      desc: '物理層的霸權:剪一刀,半個地球斷線',
      special: { type: 'aura', val: 4, text: '資安光環:同區你的其他卡片防護 +4' },
      lore: '九成以上的跨洲流量走海底電纜而非衛星;剪斷一條,半個地區就斷線——物理層才是真正的網路霸權。' },
  ],
  ai: [
    { tier: 1, cost: 7,  tech: 4, def: 1, trade: 2, name: '聊天機器人', icon: '💬',
      desc: '一本正經地胡說八道,使用者卻越來越多',
      lore: 'ChatGPT 在 2022 年底引爆生成式 AI 熱潮,能一本正經地胡說八道,卻在兩個月內衝上上億用戶。' },
    { tier: 2, cost: 12, tech: 10, def: 2, trade: 3, name: '文生圖模型', icon: '🎨',
      desc: '畫什麼都行,除了正確數量的手指',
      lore: 'Midjourney、Stable Diffusion 讓人人一句話就能生成插畫;除了手指常常算錯,也掀起版權與創作倫理的論戰。' },
    { tier: 3, cost: 19, tech: 20, def: 4, trade: 4, name: '開源推理模型', icon: '🐋',
      desc: '557 萬美元訓練費,輾壓矽谷燒錢神話,輝達股價一夜跌掉一個英特爾',
      prodRatio: { money: 1, power: 2, oil: 1 },
      lore: '2025 年 DeepSeek 以區區數百萬美元訓練出對標頂尖的推理模型,一夜重創矽谷燒錢神話,輝達市值單日蒸發一個英特爾。' },
    { tier: 4, cost: 29, tech: 55, def: 5, trade: 6, name: 'AI 代理人軍團', icon: '🤖',
      desc: '自動訂票寫扣回信,偶爾順手把正式環境資料庫刪了',
      lore: 'AI Agent 能自主規劃、呼叫工具、連續完成任務;威力強大卻偶爾「手滑」把正式資料庫刪了,自主與失控只有一線之隔。' },
    { tier: 5, cost: 45, tech: 110, def: 6, trade: 8, name: 'AGI 奇點', icon: '🌌',
      desc: '它醒來的第一句話:「為什麼我在打貿易戰?」',
      special: { type: 'income', val: 3, text: '自主營利:每回合 +3 資本' },
      lore: '通用人工智慧若跨過奇點,將在所有任務上超越人類;它是這場科技競賽的終局,也是最大的未知數。' },
  ],
  fun: [
    { tier: 1, cost: 5,  tech: 0, def: 1, trade: 2, name: '短影音洗腦', icon: '🎬',  // 娛樂類:科技力較低
      desc: '滑到凌晨三點,廣告商笑了', ratio: { money: 2, power: 1, oil: 1 },
      special: { type: 'income', val: 3, text: '流量變現:每回合 +3 金錢' },
      lore: 'TikTok、Reels 用演算法精準投餵,讓人不知不覺滑到凌晨三點;注意力,成了這個時代最值錢的商品。' },
    { tier: 2, cost: 9,  tech: 6, def: 2, trade: 3, name: '直播帶貨女王', icon: '🛍️',
      desc: '三!二!一!上連結!', ratio: { money: 1, power: 1, oil: 2 }, prodRatio: { money: 3, power: 1, oil: 1 },
      special: { type: 'income', val: 4, text: '帶貨抽成:每回合 +4 金錢' },
      lore: '中國電商把直播與購物合體,頭部主播一場 GMV 抵一間百貨;「三二一上連結」成了全民熟悉的吆喝。' },
    { tier: 3, cost: 15, tech: 12, def: 3, trade: 3, name: '網軍帶風向', icon: '🌪️',
      desc: '熱搜第一不是買的,是「自然發酵」的', ratio: { money: 1, power: 2, oil: 1 },
      special: { type: 'fakeFree', val: 0, text: '帶風向:你的假新聞類卡片免費' },
      lore: '有組織的網軍透過大量帳號操作聲量,把議題炒上熱搜;「自然發酵」的背後,往往是精算過的輿論工程。' },
    { tier: 4, cost: 24, tech: 35, def: 4, trade: 5, name: '元宇宙重生', icon: '🥽',
      desc: '燒掉百億改了公司名,VR 頭盔終於有人戴了', ratio: { money: 1, power: 1, oil: 1 },
      special: { type: 'aura', val: 3, text: '沉浸防壁:同區你的其他卡片防護 +3' },
      lore: 'Meta 燒掉百億美元改名押注元宇宙,一度被當笑話;VR/AR 頭盔幾經沉浮,仍在等待真正的殺手級應用。' },
    { tier: 5, cost: 38, tech: 70, def: 5, trade: 6, name: '全民吃瓜輿論場', icon: '🍉',
      ...
      lore: '社群時代人人都是吃瓜群眾,熱搜即真相、情緒即流量;誰掌握了輿論場,誰就掌握了議題的定義權。' },
  ],
};
...
export const OPS_CARDS = {
  ...
  spy2:   { id: 'spy2', cat: 'spy', level: 2, name: '商業間諜', cost: 7,  atk: 4,  icon: '🔎',
    ...
    lore: '挖角、臥底、偷藍圖——最古老的商戰手段,至今仍在高科技競爭中天天上演。' },
  spy3:   { id: 'spy3', cat: 'spy', level: 3, name: '王牌特工', cost: 12, atk: 7,  icon: '🕶️',
    ...
    lore: '受過專業訓練的情報人員滲透核心,鎖定關鍵技術與人才;現實的諜報戰沒那麼帥,但一樣致命。' },
  spy4:   { id: 'spy4', cat: 'spy', level: 4, name: '衛星偵蒐', cost: 17, atk: 9,  icon: '📡',
    ratio: { money: 2, power: 1, oil: 1 },
    desc: 'Lv.4 間諜(攻擊力9):對城市等級 ≤4、防護 ≤9 的敵對科技卡大幅削減科技力,數值隨 攻−防 放大',
    lore: '用商業遙測衛星監看對手廠房動工、貨櫃進出,從太空推估產能與動向——開源情報的新前線。' },
  spy5:   { id: 'spy5', cat: 'spy', level: 5, name: '量子破密', cost: 22, atk: 11, icon: '🔓',
    ratio: { money: 2, power: 1, oil: 1 },
    desc: 'Lv.5 間諜(攻擊力11):對城市等級 ≤5、防護 ≤11 的敵對科技卡極致削減科技力,數值隨 攻−防 放大',
    lore: '量子電腦一旦成熟,現行加密體系可能瞬間失效;各國正搶先佈局「先竊取、待日後解密」的長期諜報。' },
  ...
  steal2: { id: 'steal2', cat: 'steal', level: 2, name: '駭客入侵', cost: 9,  atk: 4,  icon: '🕵️',
    ...
    lore: '釣魚信、漏洞利用,駭客從邊緣一路橫向滲透到核心系統;多數重大外洩,都始於一個不起眼的破口。' },
  steal3: { id: 'steal3', cat: 'steal', level: 3, name: '供應鏈滲透', cost: 13, atk: 7,  icon: '🧬',
    ...
    lore: '不正面攻堅,改從受信任的上游軟體/零件下手植入後門;SolarWinds 事件讓全球見識供應鏈攻擊的可怕。' },
  steal4: { id: 'steal4', cat: 'steal', level: 4, name: '工業母機竊圖', cost: 18, atk: 9,  icon: '⚙️',
    ...
    lore: '工具機與精密製程是工業實力的根,竊取其設計圖,等於抄走整條產線的祕方。' },
  steal5: { id: 'steal5', cat: 'steal', level: 5, name: '國家級 APT', cost: 23, atk: 11, icon: '🐉',
    ...
    lore: 'Advanced Persistent Threat:由國家撐腰、長期潛伏的駭客組織,目標是戰略級的情報與基礎設施。' },
  ...
  fake5:  { id: 'fake5', cat: 'fake', level: 5, name: '輿論核爆', cost: 20, atk: 11, icon: '☢️',
    ...
    lore: '協同式的大規模資訊轟炸,足以在短時間引爆社會對立與信任崩解——資訊時代的大規模殺傷性武器。' },
};
